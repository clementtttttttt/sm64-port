...
ifeq ($(TARGET_N3DS),1)
  ...
  CC := $(DEVKITARM)/bin/arm-none-eabi-gcc -fno-builtin -pipe
  CXX := $(DEVKITARM)/bin/arm-none-eabi-g++ -fno-builtin -pipe
  LD := $(CXX)
endif
...
ifeq ($(TARGET_N3DS),1)
  ...
  PLATFORM_CFLAGS  := -mtp=soft -DTARGET_N3DS -DARM11 -DosGetTime=n64_osGetTime -D_3DS -march=armv6k+fp -mtune=mpcore -mfloat-abi=hard -mword-relocations -fomit-frame-pointer -ffast-math $(foreach dir,$(LIBDIRS),-I$(dir)/include) -flto=auto -fno-builtin -falign-functions=4 -falign-labels=4 -falign-loops=8 -falign-jumps=8 -funroll-loops -fomit-frame-pointer 
  PLATFORM_LDFLAGS := $(LIBPATHS) -lcitro3d -lctru -lm -specs=3dsx.specs -g -marm -mthumb-interwork -march=armv6k+fp -mtune=mpcore -mfloat-abi=hard -mtp=soft -flto=auto -fno-builtin -falign-functions=4 -falign-labels=4 -falign-loops=8 -falign-jumps=8 -funroll-loops
