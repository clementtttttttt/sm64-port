...
ifeq ($(TARGET_N3DS),1)
  ...
  PLATFORM_CFLAGS  := -mtp=soft -DTARGET_N3DS -DARM11 -DosGetTime=n64_osGetTime -D_3DS -march=armv6k+fp -mtune=mpcore -mfloat-abi=hard -mword-relocations -fomit-frame-pointer -ffast-math $(foreach dir,$(LIBDIRS),-I$(dir)/include) -flto=auto -fno-builtin -falign-functions=4 -falign-labels=4 -falign-loops=8 -falign-jumps=8 -funroll-loops
